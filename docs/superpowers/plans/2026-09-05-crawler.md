...
- [ ] **Step 1: Confirm the tests pass before the move**
...
- [ ] **Step 3: Fix the two import paths that pointed at them**
...
- [ ] **Step 4: Verify the move broke nothing**
...
- [ ] **Step 5: Create the shared seed types**
...
- [ ] **Step 2: Update every reference inside `progress.ts`**
...
- [ ] **Step 3: Update the call site in discovery**
...
- [ ] **Step 4: Inject the DataStore in the CLI**
...
- [ ] **Step 7: Prove it against a real repo**
...
- [ ] **Step 1: Extract the shared table helpers**
...
- [ ] **Step 3: Write the failing test for the history reader**
...
- [ ] **Step 1: Check whether a test pins the provisioned set**
...
- [ ] **Step 2: Provision both collection sets**
